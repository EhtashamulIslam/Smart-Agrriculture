...
def blog_home_view(request):
    ...
    if search_keyword is not None:
        blogs = PostModel.objects.filter(Q(author__user__first_name__icontains=search_keyword) | (Q(author__user__last_name__icontains=search_keyword) | (Q(title__icontains=search_keyword))))
